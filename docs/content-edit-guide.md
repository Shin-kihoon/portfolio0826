...
카드는 짧게 유지한다. **문제 한 줄 → 숫자 → 막혔던 지점 → 도구** 순이고,
왜 했는지를 문단으로 풀어 쓰지 않는다.
